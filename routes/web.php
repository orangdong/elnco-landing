...
Route::get('service', [LandingController::class, 'service_addon'])->name('service.add-on');
Route::get('service', [LandingController::class, 'service_package'])->name('service.package');
...
Route::get('corporate', [LandingController::class, 'corporate_csr'])->name('corporate.csr');
